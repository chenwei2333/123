<template>
  <div class="divhead">
    <el-menu :default-active="$route.path" class="el-menu-demo" mode="horizontal" background-color="#D0C8C8" @select="handleSelect">
      <el-row>
        <el-col :span="4">
        ...
        <el-col :span="2" >
          <el-menu-item index="/MainPage"><span>公司信息</span></el-menu-item>
        </el-col>
        <el-col :span="2">
          <el-menu-item index="/ManagerPage"><span>员工管理</span></el-menu-item>
        </el-col>
        <el-col :span="2">
          <el-menu-item index="/MessagePage"><span>消息中心</span></el-menu-item>
        </el-col>
        <el-col :span="2">
